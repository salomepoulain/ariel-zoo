...
from ariel_experiments.characterize.canonical.tree_factory import TreeFactory
from ariel_experiments.characterize.canonical.tree_processor import (
    TreeProcessor,
)
...
class CanonicalToolKit:
    ...
    to_graph = TreeExporter.to_graph
    to_string = TreeExporter.to_string
    ...
    @classmethod
    def tanimoto(cls, node1: CanonicalNode, node2: CanonicalNode, *, max_radius: int = 5, analysis_type: Literal["set", "count"] = "count") -> dict[int, float]:
