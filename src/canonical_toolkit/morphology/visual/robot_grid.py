...
from .grid_config import RobotGridConfig
...
def plot_robot_grid(
    sub_plots: list[list[RobotGridConfig]],
    ...
    """
    Plot robot image grid using cached robot images.

    Args:
        sub_plots: 2D list of RobotGridConfig objects
        cache_dir: Directory containing cached robot images (default: DATA = __data__/img)
        max_full_width: Maximum figure width in inches
        subplot_height: Height of each subplot in inches
        main_title: Optional title for the entire grid
        robot_gap_px: Gap between robot images in pixels
